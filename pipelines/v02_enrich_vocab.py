...
from src.agent.tools import german_agent

INPUT_FILE = "data/topics_vocab.json"
OUTPUT_FILE = "data/topics_vocab_enriched.json"
...
# Saving the enriched vocabulary
